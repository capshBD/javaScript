...
function getScroll() {
  return {
    scrollTop: document.documentElement.scrollTop || document.body.scrollTop, //顶部被卷起的高度
    scrollLeft: document.documentElement.scrollLeft || document.body.scrollLeft //左侧被卷起的宽度
  }
}
